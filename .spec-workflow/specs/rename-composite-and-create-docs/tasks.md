...
- [x] 1. `.github/composite/` を `.github/actions/` にリネーム
...
- [x] 2. 参照ファイルの一括更新（`.github/composite` → `.github/actions`）
...
- [x] 4. `.github/workflows/docs/` に Reusable Workflow 詳細ドキュメントを作成
...
- [x] 5. `.github/actions/docs/` に Composite Action 詳細ドキュメントを作成
...
- [x] 6. `.github/workflows/README.md` を作成
...
- [x] 7. `.github/actions/README.md` を作成
