...
- [x] 7. package.json の作成と npm install
...
- [x] 9. .github/workflows/my_test.yml の作成
...
- [x] 10. .github/workflows/my_setup_pr.yml の作成
...
- [x] 11. .github/workflows/my_release.yml の作成
...
- [x] 12. .github/workflows/my_codeql.yml の作成
...
- [x] 13. docs/adr/ ディレクトリの作成と初期 ADR
